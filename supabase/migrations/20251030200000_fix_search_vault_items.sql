-- =====================================================
-- FIX SEARCH_VAULT_ITEMS FUNCTION - Career Vault 2.0
-- =====================================================
-- This migration fixes the search function to:
-- 1. Search ALL 10 vault tables (not just 3)
-- 2. Accept both string and array parameters
-- 3. Return correct column names matching edge function
-- 4. Include confidence_score and effectiveness_score
-- =====================================================
...
BEGIN
  ...
  SELECT
    ...
    pp.quality_tier::VARCHAR(20),
    COALESCE(pp.confidence_score, 0)::DECIMAL as confidence_score,
    COALESCE(pp.effectiveness_score, 0)::DECIMAL as effectiveness_score,
  ...
  SELECT
    ...
    COALESCE(ts.confidence_score, 0)::DECIMAL,
    0::DECIMAL,
  ...
  SELECT
    ...
    COALESCE(hc.confidence_score, 0)::DECIMAL,
    0::DECIMAL,
