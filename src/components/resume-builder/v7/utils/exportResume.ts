/**
 * V7 Resume Export Utilities
 * Actual PDF, DOCX, and TXT generation
 */

import jsPDF from 'jspdf';
import { Document, Packer, Paragraph, TextRun, HeadingLevel } from 'docx';
import { saveAs } from 'file-saver';
import type { SectionContent, SectionType, DetectedInfo } from '../types';
...
/**
 * Get resume content as plain text (for copying)
 */
export function getResumeAsText(data: ExportData): string {
  let text = '';
